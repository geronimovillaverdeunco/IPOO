...
$librito = new Libro("LOTR", "Toljien");
$librito2 = new Libro("Señor anillos", "Gandalf");
$librito3 = new Libro("Stars born", "Lady gaga");



 
$biblioteca = new Biblioteca("Rivadavia");
$biblioteca->agregarLibro($librito);
$biblioteca->agregarLibro($librito2);
$biblioteca->agregarLibro($librito3);
echo $biblioteca->mostrarLibrosDisponibles();
